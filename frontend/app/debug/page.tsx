...
//     try {
//       const response = await fetch('https://tm-backend-fhb2.onrender.com/debug/cookies', {
...
//     try {
//       const response = await fetch('https://tm-backend-fhb2.onrender.com/debug/token-info', {
//         credentials: 'include'
//       });
//       const data = await response.json();
//       setTokenInfo(data);
...
//     try {
//       const response = await fetch('https://tm-backend-fhb2.onrender.com/profile', {
//         credentials: 'include'
//       });
//       const data = await response.json();
//       setProfileInfo(data);
...
//             <button 
//               onClick={async () => {
//                 const response = await fetch('https://tm-backend-fhb2.onrender.com/logout', {
//                   method: 'POST',
//                   credentials: 'include'
//                 });
